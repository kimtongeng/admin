export default {
  ...
  messages: {
    ...
    email: `The emaill address must be a valid email.`,
    ...
    max_value: (field, [max]) =>
      `The ${field} field must be ${max} or less.`,
    ...
    strong_password: `The Password field must be at least 8 characters from uppercase letter, lowercase letter and number.`,
    url_http_or_https: (field) =>
      `The ${field} field is not a valid URL. The front must have http:// or https://`,
    url_youtube: field =>
      `The ${field} field is not a valid URL. The URL must be youtube url only`
  },
}
